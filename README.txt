...
dataprocess_seg.ipynb: pre-processing of the raw data before the segmentation，and obtain Train_img folder, Test_img folder, Mask_LV folder and Mask_noLV folder.
